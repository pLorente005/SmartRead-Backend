...
namespace FunctionAppSmartRead
{
    public class Function
    {
            ...
            [HttpTrigger(AuthorizationLevel.Function, "get", "post")] HttpRequest req)
        {
            ...
            {
                return new BadRequestObjectResult("Debe proporcionar el parámetro 'action' (por ejemplo, 'login' o 'register').");
            }
            ...
            switch (action.ToLower())
            {
                ...
                case "auth":
                    {
                        ...
                        return userCount > 0
                            ? new OkObjectResult("Autenticación exitosa.")
                ...
                default:
                    return new BadRequestObjectResult("La acción especificada no es válida. Use 'login' o 'register'.");
            }
        }
    }
}